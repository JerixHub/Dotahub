...
import { u as useStore } from "./store-Da_0sG9e.js";
...
import "devalue";
import "ohash";
const __nuxt_component_0_lazy = defineAsyncComponent(() => import("./Profile-CGhbz_Um.js").then((c) => c.default || c));
const __nuxt_component_1_lazy = defineAsyncComponent(() => import("./Overview-BcTMn_Of.js").then((c) => c.default || c));
const _sfc_main = {
  __name: "[id]",
...
//# sourceMappingURL=_id_-CLz9asVU.js.map
