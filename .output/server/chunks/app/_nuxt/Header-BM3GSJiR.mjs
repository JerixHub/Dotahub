...
import { _ as __nuxt_component_0$3 } from './nuxt-link-Cw2BywKJ.mjs';
import { useSSRContext, mergeProps, withCtx, unref, createVNode, ref, computed, resolveComponent, toDisplayString } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate } from 'vue/server-renderer';
import { a as useToast, u as useStore } from './store-Da_0sG9e.mjs';
...
const Logo = "" + buildAssetsURL("logo.BQFpiwrO.png");
const _sfc_main = {
  __name: "Header",
  __ssrInlineRender: true,
  props: {
...
//# sourceMappingURL=Header-BM3GSJiR.mjs.map
